...
//    //modifyAccount()
//    @Test(expected = NullPointerException.class)
//    public void modifyAccountNullPointer() throws InvalidInputException {
//        FunctionDefinitions.modifyAccount(null,0);
//    }
//
//    @Test(expected = InvalidInputException.class)
//    public void modifyAccountInvalidInput() throws InvalidInputException {
//        Contestant x = new Contestant("test", Position.LEFT);
//        x.setContestantsTurn(false);
//        FunctionDefinitions.modifyAccount(x,0);
//
//        Contestant[] contestants = {new Contestant("test", Position.LEFT),
//                                    new Contestant("test",null),
//                                    new Contestant(null, Position.LEFT),
//                                    new Contestant(null,null)};
//        for (int i = 1; i < contestants.length; i++) {
//            contestants[i].setContestantsTurn(true);
//            FunctionDefinitions.modifyAccount(contestants[i],0);
//        }
//
//        int[] tests = {-251,-249,1,501};
//        for (int i: tests) {
//            FunctionDefinitions.modifyAccount(contestants[0],i);
//        }
//    }
//
//    @Test
//    public void modifyAccountTest() throws InvalidInputException {
//        Contestant[] contestants = {new Contestant("test", Position.LEFT),
//                                    new Contestant("test", Position.RIGHT),
//                                    new Contestant("test", Position.MIDDLE)};
//        int next = 0;
//        for (Contestant c: contestants) {
//            c.setContestantsTurn(true);
...
//                        next = 0;
//                    } else {
//                        next = Integer.parseInt(s) * x;
//                    }
//                    FunctionDefinitions.modifyAccount(c,next);
//                    Assert.assertEquals(next,c.getRoundEarnings());
